<?php
	session_start();
	$_SESSION['DASHBOARD'] = 'ess-enrollment-process-process-form.php';
...
?>
	...
	<?php
		...
		{	
			...
			$createTable .= "<a href='enrollmentregistrationform.php?userid=".$regitem['VIEW']."' target = '_blank'><button type='button' class='btn btn-primary' onSubmit='window.location.reload()'' >View Profile</button></a>";
